        ...
        list = _.map(list, function (data) {
          ...
          if (!search || !term || modified.keywords.some(function (keyword) {
            ...
            return React.createElement(
              ...
              React.createElement(
                LazyLoad,
                { once: true, key: modified.unicode, height: 32, offset: [0, 0], overflow: true, debounce: 300, scroll: false },
                React.createElement(Emoji, _extends({}, modified, { "aria-label": modified.name,
                  role: "option",
                  onClick: function () {
                    onChange(modified);
                  } }))
